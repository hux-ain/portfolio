            ...
            <div class="card-body">
                <form action="{{ route('admin.skills.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('icon_class') is-invalid @enderror" name="icon_class" value="{{ old('icon_class') }}" placeholder="e.g., fab fa-laravel, fas fa-database">
                        <small class="text-muted">Use FontAwesome classes. Check: <a href="https://fontawesome.com/icons" target="_blank">fontawesome.com/icons</a></small>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="range" class="form-range @error('proficiency_level') is-invalid @enderror" name="proficiency_level" min="0" max="100" value="{{ old('proficiency_level', 80) }}" id="proficiencyRange">
                        <div class="d-flex justify-content-between">
                            <small>0%</small>
                            <span id="proficiencyValue">{{ old('proficiency_level', 80) }}%</span>
                            <small>100%</small>
                        </div>
